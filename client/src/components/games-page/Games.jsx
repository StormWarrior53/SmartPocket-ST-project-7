    ...
    return (
        ...
        >
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
                ...
                {/* Boy Image */}
                <div className="flex justify-center w-full md:w-1/3 mt-25">
                    <img
                ...
                <div className="backdrop-blur-lg bg-white/50 p-8 rounded-2xl shadow-lg w-full md:w-1/3 text-center">
                    ...
                    <p className="mt-4 text-slate-700">
                        Predict future trade moves based on trends. Coming soon!
                    </p>

                    <span className="inline-block mt-4 px-6 py-2 bg-gray-300 text-slate-700 rounded-xl shadow cursor-not-allowed">
                        Coming Soon
                    </span>
                </div>
